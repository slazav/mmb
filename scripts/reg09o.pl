...
my $mmb_dates='23-25 октября 2009';
my $reg_end_date='24:00 12 октября';
my $pol_ref='http://slazav.mccme.ru/mmb/pol09o.htm';
...
my $script='http://slazav.mccme.ru/perl/reg09o.pl';
...
sub print_start_page{
  print qq* 
    ...
    прочитайте <a href="$pol_ref">Положение</a>.
