...
my $dfile = '/home/slazav/mmb06o.dat'; 
#my $dfile = '/home/slazav/mmb_data';

## адрес скрипта
#my $script='http://localhost/mb/reg05l.pl';
my $script='http://slazav.mccme.ru/perl/reg06o.pl';
...
sub print_start_page{
  print qq* 
    ...
    28-29 октября 2006 года</h3><hr>
    <h3 align=center>Регистрация команд</h3>

    <p><table border=0 cellpadding=5><tr><td valign=top>

    <p>Регистрация работает до 23 октября 2006г включительно.

    <p>Прежде, чем регистрироваться для участия в марш-броске,
    прочитайте <a href="http://slazav.mccme.ru/mmb/pol06o.htm">Положение</a>.
...
To: $mail
Subject: mmb2006o password
Content-Type: text/plain; charset="koi8-r"


    Ваша команда была зарегистрирована на
    участие в Московском марш-броске Осень-2006
