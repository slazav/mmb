...
my $dfile = '/home/slazav/mmb08.dat'; 
#my $dfile = '/home/slazav/mmb_data';

## адрес скрипта
#my $script='http://localhost/mb/reg05l.pl';
my $script='http://slazav.mccme.ru/perl/reg08.pl';
...
sub print_start_page{
  print qq* 
    ...
    16-18 мая 2008 года</h3><hr>
    <h3 align=center>Регистрация команд</h3>

    <p><table border=0 cellpadding=5><tr><td valign=top>

    <p>Регистрация работает до 28 апреля 2008г включительно.

    <p>Прежде, чем регистрироваться для участия в марш-броске,
    прочитайте <a href="http://slazav.mccme.ru/mmb/pol08.htm">Положение</a>.
  ...
  *;
  ...
  print qq* 
    ...
    <th>Дистанция А (65 км)</th>
    <th>Дистанция Б (75 км)</th>
    </tr>
    <tr>
  *;
...
To: $mail
Subject: mmb2008 password
Content-Type: text/plain; charset="koi8-r"


    Ваша команда была зарегистрирована на
    участие в Московском марш-броске Весна-2008
...
sub html_rr2_form{
  ...
  $out.= qq*
    ...
    Вариант дистанции:
     А (65 км)<input name="dist" type="radio" $A value="0">&nbsp;
     Б (75 км)<input name="dist" type="radio" $B value="1"><br><br>
    Контактный адрес:
