...
my $mmb_dates='15-17 мая 2009';
my $reg_end_date='24:00 27 апреля';
my $a_size='60 км';
my $b_size='80 км';
...
my $script='http://slazav.mccme.ru/perl/reg09.pl';
...
sub print_start_page{
  print qq* 
    ...
    прочитайте <a href="http://slazav.mccme.ru/mmb/pol09.htm">Положение</a>.
