...
my $dfile = '/home/slazav/mmb05l.dat'; 
#my $dfile = '/home/slazav/mmb_data';

## адрес скрипта
#my $script='http://localhost/mb/reg05l.pl';
my $script='http://slazav.mccme.ru/perl/reg05l.pl';
...
sub print_start_page{
  print qq* 
    ...
    <h3 align=center> Малый Московский марш-бросок<br>
    29-30 октября 2005 года</h3><hr>
    <h3 align=center>Регистрация команд</h3>

    <p><table border=0 cellpadding=5><tr><td valign=top>

    <p>Регистрация работает до 24 октября 2005г.

    <p>Прежде, чем регистрироваться для участия в марш-броске,
    прочитайте <a href="http://slazav.mccme.ru/mmb/mmb2005l.htm">Положение</a>.
    ...
    неделю до соревнований) и результаты марш-броска. Адреса не будут
    публиковаться в интернете. Внимание: на один из этих адресов <a
    href="#pass">по специальному запросу</a> может быть автоматически
    выслан ваш пароль.
  ...
  *;
  ...
  print qq* 
    ...
    <th>Дистанция А (35 км)</th>
    <th>Дистанция Б (45 км)</th>
    </tr>
    <tr>
  *;
...
To: $mail
Subject: mmb2005-lite password
Content-Type: text/plain; charset="koi8-r"


    Ваша команда была зарегистрирована на
    участие в Малом московском марш-броске 2005
...
sub html_rr2_form{
  ...
  $out.= qq*
    ...
    Вариант дистанции:
     А (35 км)<input name="dist" type="radio" $A value="0">
     Б (45 км)<input name="dist" type="radio" $B value="1"><br><br>
    Контактный адрес:
