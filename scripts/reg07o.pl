...
my $dfile = '/home/slazav/mmb07o.dat'; 
#my $dfile = '/home/slazav/mmb_data';

## адрес скрипта
#my $script='http://localhost/mb/reg05l.pl';
my $script='http://slazav.mccme.ru/perl/reg07o.pl';
...
sub print_start_page{
  print qq* 
    ...
    27-28 октября 2007 года</h3><hr>
    <h3 align=center>Регистрация команд</h3>

    <p><table border=0 cellpadding=5><tr><td valign=top>

    <p>Регистрация работает до 8:00 23 октября (вторник).

    <p>Прежде, чем регистрироваться для участия в марш-броске,
    прочитайте <a href="http://slazav.mccme.ru/mmb/pol07o.htm">Положение</a>.

    <p>По всем вопросам обращайтесь по адресу <i>atonis</zz>\@mail.ru</i> (Саша Тонис).
    ...
    редактировать информацию или удалить команду. 
