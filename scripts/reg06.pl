...
my $dfile = '/home/slazav/mmb06.dat'; 
#my $dfile = '/home/slazav/mmb_data';

## адрес скрипта
#my $script='http://localhost/mb/reg05l.pl';
my $script='http://slazav.mccme.ru/perl/reg06.pl';
...
To: $mail
Subject: mmb2006 password
Content-Type: text/plain; charset="koi8-r"


    Ваша команда была зарегистрирована на
    участие в Малом московском марш-броске 2006
