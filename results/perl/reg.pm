...
my @names = ("Айдар", "Александр", "Александра", "Алексей", "Алёна",
"Алёнка", "Алина", "Алиса", "Алла", "Алька", "Анастасия", "Анатолий",
"Ангелина", "Андрей", "Андрюха", "Анна", "Аннушка", "Антон",
"Антонина", "Анюта", "Аня", "Арина", "Аркадий", "Арсений", "Артем",
"Артём", "Ася", "Батр", "Беляев", "Борис", "Булгун", "Буличка",
"Вадим", "Валентина", "Валерий", "Варвара", "Варвара", "Василий",
"Вера", "Вероника", "Виктор", "Виктория", "Виталий", "Владимир",
"Владислав", "Володя", "Всеволод", "Вячеслав", "Галина", "Галя",
"Геннадий", "Георгий", "Герман", "Глеб", "Григорий", "Гриша",
"Даниил", "Данил", "Данила", "Дарья", "Даша", "Денис", "Дима",
"Димтрий", "Дина", "Дмитрий", "Дольган", "Евгений", "Евгения", "Егор",
"Екатерина", "Елена", "Елизавета", "Жанна", "Женя", "Иван", "Игнат",
"Игорь", "Ильдар", "Илья", "Инка", "Инна", "Ирина", "Карен", "Карина",
"Катя", "Катерина", "Кирилл", "Константин", "Ксения", "Курамин",
"Лада", "Лев", "Левон", "Лена", "Леонид", "Леша", "Лёня", "Любовь",
"Людмила", "Макс", "Максим", "Малика", "Марат", "Маргарита",
"Марианна", "Марина", "Мария", "Марк", "Марлен", "Маша", "Михаил",
"Митяй", "Миха", "Миша", "Модест", "Надежда", "Надя", "Настя",
"Наталья", "Наталя", "Нектарий", "Ник", "Никита", "Николай", "Нина",
"Оксана", "Олег", "Олеся", "Ольга", "Оля", "Павел", "Петр",
"Петруччо", "Пётр", "Ползунов", "Ринат", "Рита", "Роман", "Руслан",
"Саша", "Света", "Светлана", "Святослав", "Седова", "Семён", "Сергей",
"Сердар", "Соня", "Софья", "Станислав", "Стас", "Степан", "Сузан",
"Тадеуш", "Таисия", "Тамара", "Татьяна", "Тим", "Тимофей", "Тимур",
"Толли", "Тоня", "Эдуард", "Элина",  "Юлия", "Юля", "Юрий", "Яков",
"Яна", "Ярослав",  "Платон", "Полина", "Катюха", "Лилия", "Толик",
"Ева", "Лариса", "Слава", "Наташа", "Федор", "Кристина", "Ира",
"Алан", "Митя", "Виолетта", "Женек", "Димон", "Зоя", "Ульяна", "Вова",
"Ира", "Азат", "Вика", "Венера", "Артемий", "Костя", "Филипп",
"Алекс", "Валера", "Марсель", "Лера", "Аленка", "Прохор", "Наталия", 
"Елисей", "Яша");
